 ...
 * 
 */
public class KmeansModified implements Clusterer {
    /**
     ...
     */
    public KmeansModified(int clusters, int iterations) {
     ...
     */
    public KmeansModified(int clusters, int iterations, DistanceMeasure dm) {
